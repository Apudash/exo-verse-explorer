...
class ApiService {
  ...
  async getModelPerformance(mission: "kepler" | "tess"): Promise<ModelPerformanceData> {
    return this.request<ModelPerformanceData>(
      config.ENDPOINTS.MODEL_PERFORMANCE(mission)
    );
  }
}
